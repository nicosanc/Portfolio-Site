                ...
                <li li className="flex flex-col justify-center w-1/2 p-8 items-end">
                 <p className='text-center text-indigo-700 text-xl font-segoe'>
                    ...
                    <p className='text-center text-indigo-700 text-xl font-segoe mt-5'>
                        ...
                        datetime library) object, converts the new object to type UTC, then outputs the difference in time. The specific use case for this functionality is to produce simple, human readable time differences such as &quot;1h&quot; or &quot;25d&quot; for one hour ago and 25 days ago, respectively.
