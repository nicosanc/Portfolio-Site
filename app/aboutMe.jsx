           ...
           <ul className="flex justify-between">
                ...
                <p className='text-center text-indigo-700 text-xl font-segoe'>
                    ...
                    <p className= 'text-center text-indigo-700 text-xl font-segoe mt-5'>
                        I&apos;ve grown up playing soccer and tennis. I love the outdoors so I&apos;m a big fan of runs, bike rides, and ocean related activities. I am a sociable person and I pride myself in my communication skills. I believe it
