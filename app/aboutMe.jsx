           ...
           <ul className="flex justify-between">
                ...
                <li className="flex flex-col w-1/2 px-24 items-end">
                    ...
                    This translated into my professional life, which is why I have committed myself to deeply learn the topics relevant to the career I want to pursue. Cal Newton, an author and Computer Science professor at
                        ...
                        but also because I&aposve noticed many overlaps with my own personal journey of learning about myself. My professional goal is to be so knowledgable on these topics and to build such a substantial repetoir of experience, that I can create a career for myself that I can truly feel passionate about. 
                    </p>
                </li>
            </ul>
