...
const AboutMe = () => {
    return(
        ...
        <div className="mt-20">
           ...
           <h1 className='text-4xl text-teal-300 flex justify-center mb-10'> About Me </h1>
           <ul className="flex justify-between">
                <li className="flex flex-col w-1/2 px-24">
                    <p className= 'text-xl text-justify text-teal-200'>
                ...
                <li className="flex flex-col w-1/2 px-24 items-end">
                    <p className= 'text-xl text-justify text-teal-200'>
                    This translated into my professional life, which is why I have committed myself to deeply learn the topics relevant to the career I want to pursue. Author Cal Newport&apos;s book  &quot;So Good They Can&apos;t Ignore You&quot; 
